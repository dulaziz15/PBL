        ...
        success: function(data) {
            ...
            tableContent += `
                ...
                <div class="card-dashboard">
                    ...
                    <h4>${data.total_bebas_tanggungan}</h4>
                    <div class="jumlah-ta">
                        <div class="verify">
                            <h4>Verify</h4>
                        ...
                        <div class="revisi">
                            <h4>Revisi</h4>
                            <h4>${data.total_dokumen - data.bebas_tanggungan_approved}</h4>
                        </div>
                    </div>
                </div>`;
            ...
            const barChart = new Chart(ctxBar, {
                type: 'bar',
                data: {
                    labels: ['verify', 'Revisi'], // Label untuk setiap kategori
                    datasets: [{
                        label: 'Jumlah Dokumen TA',
                        data: [data.ta_approved, data.total_ta - data.ta_approved], // Data penjualan
            ...
            // Grafik Bar - Menampilkan Statistik Penjualan
            const ctxBar2 = document.getElementById('barChart2').getContext('2d');
            const barChart2 = new Chart(ctxBar2, {
                type: 'bar',
                data: {
                    labels: ['Approved', 'Pending'], // Label untuk setiap kategori
                    datasets: [{
                        label: 'Jumlah Bebas Tanggungan',
                        data: [data.bebas_tanggungan_approved, data.total_dokumen - data.bebas_tanggungan_approved], // Data penjualan
